...
Visibility Law (own reads live on tools/verify; a private dashboard behind sign-in ≠ hiding a public fact; we still SHOW the money everywhere it's shown) · ADR-003 (own-row; ⛔ « the only memberNumber↔wallet pairing = the founder_root-gated §D member-ledger » STRUCK 2026-07-30 — THE REGISTER (`/registry`, construit sur ordre du fondateur) publie le couple siège↔adresse par siège, adresse-seulement, sous la loi d'adresse du 2026-07-25 ; l'interdit qui reste est l'annuaire nom↔adresse) · Q-B (session persists → gate NOT-SIGNED only) · naming canon.
