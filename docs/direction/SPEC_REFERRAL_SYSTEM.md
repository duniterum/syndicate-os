...
| **Un parrain doit détenir du SYN** | *« Holding SYN pays you nothing. Introductions pay you. »* *« You must hold SYN to introduce others — any amount, no minimum. You cannot recommend what you have left. »* ⛔ *(corrigé 2026-08-03 : la phrase prescrite ici exigeait un SIÈGE. Le contrat ne l'a jamais vérifié — voir §262 et §436 de ce même document : « ReferrerNotSeated ne vérifie pas le siège. Il vérifie le solde. » Cette ligne était la RACINE qui re-semait l'erreur dans chaque surface écrite depuis la spec — 17 surfaces au total.)* |
