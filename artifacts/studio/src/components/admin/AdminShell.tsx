...
export const ADMIN_SECTIONS = [
  ...
  // S2-final (2026-07-24): the Seasons 2 rails — with the growth cluster,
  // ahead of the governance tail (one icon language: Trophy = the season).
  { path: "/admin/seasons", label: "Seasons", icon: Trophy, render: AdminSeasonsSection },
