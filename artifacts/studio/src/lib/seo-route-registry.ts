...
export const seoRouteRegistry: SeoRouteEntry[] = [
  ...
  },
  {
    ...
    indexStatus: "INDEX",
    sitemap: true,
    title: "Recognition — How The Syndicate Recognizes Its Builders",
    description:
      "How The Syndicate recognizes members: the live season board ranks contribution from chain-proven acts, and quests credit real acts. Recognition of participation, never a financial reward.",
