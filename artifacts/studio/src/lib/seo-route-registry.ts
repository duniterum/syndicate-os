...
/**
 * Every actual route in `src/App.tsx` (10 explicit routes + the catch-all).
...
export const seoRouteRegistry: SeoRouteEntry[] = [
  ...
  },
  {
    ...
    description:
      "Public, auditable proof of protocol facts. Design preview only — no proof adapters are wired yet.",
    canonicalPath: null,
    ogImage: DEFAULT_OG_IMAGE,
    ownerSurface: "transparency",
    primaryIntent: "verify",
    proofRoute: "/proof",
    notes: "DESIGN_PREVIEW (placeholder data). NOINDEX until proof is wired.",
  },
  {
    path: "/member",
    routeType: "PENDING",
    ...
    description:
      "Membership is founder-gated and not live yet; this will explain how a seat works once the protocol is wired.",
    canonicalPath: null,
    ogImage: DEFAULT_OG_IMAGE,
    ...
    proofRoute: "/status",
    notes:
      "Thin placeholder, no CTA today. NOINDEX until it has real content + CTA (2.18C/2.18J).",
  },
  {
    path: "/learning",
    routeType: "PENDING",
    ...
    description:
      "Plain-language education on how the protocol works. Placeholder module — no content yet.",
    canonicalPath: null,
    ogImage: DEFAULT_OG_IMAGE,
    ownerSurface: "education",
    primaryIntent: "education",
    proofRoute: "/status",
    notes: "FUTURE_MODULE. NOINDEX until content (2.18I).",
  },
  {
    path: "/recognition",
    routeType: "PENDING",
    ...
    title: "Recognition",
    description:
      "Recognition module — placeholder. No content is wired yet.",
    canonicalPath: null,
    ogImage: DEFAULT_OG_IMAGE,
    ownerSurface: "recognition",
    primaryIntent: "recognition",
    proofRoute: "/status",
    notes: "FUTURE_MODULE. NOINDEX until content.",
  },
  {
    path: "/studio",
    routeType: "INTERNAL",
