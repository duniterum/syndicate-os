...
export const seoRouteRegistry: SeoRouteEntry[] = [
  ...
  // public promise with a posture badge — never a fake surface.
  {
    ...
    description:
      "The protocol's public heartbeat: the complete indexed history — seats written, burns numbered, referral events, liquidity, archive mints and milestone crossings — every line a receipt-backed sentence with its own verify link.",
    ...
    proofRoute: "/status",
    notes:
      "Complete served history (indexer) + recent-window freshness layer. H2-⑬: the Milestones panel — canonical crossings anchored to their exact transactions.",
  },
  {
    path: "/chronicle",
    routeType: "PUBLIC",
