...
export const modules = [
  ...
  },
  {
    ...
    phase: "live",
    description:
      "The public press & brand kit: official descriptions, the served mark, the only official channels, protocol facts with verify paths, approved and banned language.",
    dependencies: [],
    nav: { header: false, sidebar: false, footer: true },
    icon: Newspaper,
  },
