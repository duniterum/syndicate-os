...
export const surfaceClassification: SurfaceClassificationEntry[] = [
  ...
  // §11 slot 2c designed teasers — honest PENDING promises, public shell.
  {
    ...
    surface: "PUBLIC_VISITOR",
    layout: "public",
    summary: "Activity teaser — the public heartbeat; arrives with the event backbone.",
    requiredState: "S1",
    enforcement: "PREVIEW_LABELLED",
  },
  {
  ...
  },
  {
    ...
    surface: "PUBLIC_VISITOR",
    layout: "public",
    summary: "Fire Ledger teaser — total burn live; per-event ledger arrives with the backbone.",
    requiredState: "S1",
    enforcement: "PREVIEW_LABELLED",
  },
  {
