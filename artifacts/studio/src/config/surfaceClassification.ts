...
export const surfaceClassification: SurfaceClassificationEntry[] = [
  ...
  },
  {
    ...
    surface: "PUBLIC_VISITOR",
    layout: "public",
    summary: "Contract & economy memory (roles + lifecycle).",
    requiredState: "S1",
    enforcement: "PREVIEW_LABELLED",
  },
  {
  ...
  },
  {
    ...
    surface: "PUBLIC_VISITOR",
    layout: "public",
    summary: "Recognition — the live season board and member quests today; the long-term standing figure is still to come.",
    requiredState: "S1",
    enforcement: "PREVIEW_LABELLED",
  },
  {
    ...
    layout: "public",
    summary:
      "Public wallet session + live self-readback of the signed wallet's standing. Session ≠ membership.",
    requiredState: "S7",
    enforcement: "PREVIEW_LABELLED",
  },
  {
  ...
  },
  {
    ...
    layout: "public",
    summary:
      "Public Verified-Introduction link builder: registry validation only.",
    requiredState: "S1",
    enforcement: "PREVIEW_LABELLED",
  },
  {
  ...
  },
  {
    ...
    surface: "PRIVATE_OPERATOR_ADMIN",
    layout: "console",
    summary: "Admin section: module registry governance overlay — nothing is changed here.",
    requiredState: "S11",
    enforcement: "PREVIEW_LABELLED",
  },
  {
  ...
  },
  {
    ...
    surface: "PRIVATE_OPERATOR_ADMIN",
    layout: "console",
    summary: "Admin section: build flags and system health.",
    requiredState: "S11",
    enforcement: "PREVIEW_LABELLED",
  },
];
