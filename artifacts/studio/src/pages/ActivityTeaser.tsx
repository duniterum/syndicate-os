...
export default function ActivityTeaser() {
  return (
    <PublicPage
      ...
      lead="The protocol speaks through verified receipts. Seats, burns, referral events, liquidity, archive mints, treasury movements and milestone crossings are served by the event indexer — the complete on-chain record, newest first — refreshed live from the chain between cycles. Every line carries its own verify link — aggregate and address-safe, never a claim."
    ...
    >
      ...
      <Card className="bg-card/20 border-dashed border-border/60 p-5 mt-10">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          referral lifecycle, liquidity, archive, treasury movements and
          milestone crossings — not a window. What it adds next: era
